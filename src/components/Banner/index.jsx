...
import { MoonSVG, SearchSVG } from "../Icons"
...
export function Banner({children}) {
  ...
  return (
    <>
      <div
        id="main"
        className="relative flex h-[calc(100vh_-_75px)] flex-col justify-center p-12 max-sm:items-center max-sm:justify-between pt-20"
      >
        <img
          src={bannerUrl}
          alt="banner"
        ...
        <div className="relative flex w-full justify-center gap-3 rounded-3xl bg-white py-4 px-2 max-sm:shadow-2xl sm:hidden">
          {SearchSVG(true)}
          <input
            type="text"
